...

{
...

	{
		...
		File filetr = new File("F:/finalbigdatacsv/csv/tracks.csv");
		File fileal = new File("F:/finalbigdatacsv/csv/albums.csv");
		File fileso = new File("F:/finalbigdatacsv/csv/songs.csv");
		File filerec = new File("F:/finalbigdatacsv/csv/recorded.csv");
		File fileco = new File("F:/finalbigdatacsv/csv/composes.csv");

		FileWriter fileWrittertr = null;
		BufferedWriter bufferWrittertr = null;
		
		FileWriter fileWritteral = null;
		BufferedWriter bufferWritteral = null;
		
		FileWriter fileWritterso = null;
		BufferedWriter bufferWritterso = null;
		...
		try {
			fileWrittertr = new FileWriter(filetr, true);
			bufferWrittertr = new BufferedWriter(fileWrittertr);
			
			fileWritteral = new FileWriter(fileal, true);
			bufferWritteral = new BufferedWriter(fileWritteral);
			
			fileWritterso = new FileWriter(fileso, true);
			bufferWritterso = new BufferedWriter(fileWritterso);
