...

{
	...
	File file =new File("F:/csv/artiststerms.csv");
	...
	File file1 =new File("artiststerms.csv");  
	File file2 =new File("artistsmbartists.csv");  
	...
	try {
	   ...
	   /* System.out.println("artist name: " + get_artist_name(h5));
	    ...
	    /*bufferWritter.write(get_title(h5)+ "#");
	    bufferWritter.flush();
	    ...
	    if(resS != null) {
	    	...
	    	bufferWritter.write(artistId + "#");
		    bufferWritter.flush();
		    bufferWritter.write(resS[j]);
		    bufferWritter.newLine();
		    bufferWritter.flush();
	    	}
...
//	    bufferWritter.write("" + cou++ + "#");
	//    bufferWritter.flush();
	  ...
	  //  bufferWritter.write("" + get_year(h5)+ "#");
	    ...
	    //bufferWritter.write(get_release(h5));
	    //bufferWritter.flush();
