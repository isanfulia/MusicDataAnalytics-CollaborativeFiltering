...

{
...

	{
		...
		File filear = new File("F:/finalbigdatacsv/csv/artists.csv");
		File fileart = new File("F:/finalbigdatacsv/csv/artiststerms.csv");
		File filesar = new File("F:/finalbigdatacsv/csv/similarartists.csv");
		/*File filerec = new File("F:/finalbigdatacsv/csv/recorded.csv");
		File fileco = new File("F:/finalbigdatacsv/csv/composes.csv");
*/
		FileWriter fileWritterar = null;
		BufferedWriter bufferWritterar = null;
		
		FileWriter fileWritterart = null;
		BufferedWriter bufferWritterart = null;
		
		FileWriter fileWrittersar = null;
		BufferedWriter bufferWrittersar = null;
		
		/*FileWriter fileWritterrec = null;
		BufferedWriter bufferWritterrec = null;
		
		FileWriter fileWritterco = null;
		BufferedWriter bufferWritterco = null;*/
		try {
			fileWritterar = new FileWriter(filear, true);
			bufferWritterar = new BufferedWriter(fileWritterar);
			
			fileWritterart = new FileWriter(fileart, true);
			bufferWritterart = new BufferedWriter(fileWritterart);
			
			fileWrittersar = new FileWriter(filesar, true);
			bufferWrittersar = new BufferedWriter(fileWrittersar);
			
			/*fileWritterrec = new FileWriter(filerec, true);
			bufferWritterrec = new BufferedWriter(fileWritterrec);
			
			fileWritterco = new FileWriter(fileco, true);
			bufferWritterco = new BufferedWriter(fileWritterco);*/
				...
				for (char i : alphabet) {
					...
					if (files != null) {
						for (int index = 0; index < files.length; index++) {
							...
							if (nSongs > 1)
								System.out
										.println("we'll display infor for song 0");
							...
							try {
								 ...
								 * get_artist_id(h5));
								 * bufferWritter.write(get_artist_id(h5)+ "#");
								 * bufferWritter.flush();
								 */
								// System.out.println("artist mbid: " +
								// get_artist_mbid(h5));

								// System.out.println("artist playmeid: " +
								// get_artist_playmeid(h5));

								// System.out.println("artist 7digitalid: " +
								// get_artist_7digitalid(h5));

								// System.out.println("artist latitude: " +
								// get_artist_latitude(h5));

								// System.out.println("artist longitude: " +
								// get_artist_longitude(h5));

								/*
								 * System.out.println("artist location: " +
								 * get_artist_location(h5));
								 * bufferWritter.write(get_artist_location(h5)+
								 * "#"); bufferWritter.flush();
								 * 
								 * System.out.println("artist name: " +
								 * get_artist_name(h5));
								 * bufferWritter.write(get_artist_name(h5));
								 ...
								 * 
								 * System.out.println("song hotttnesss: " +
								 * get_song_hotttnesss(h5));
								 */

								/*bufferWrittertr
										.write("" + get_track_id(h5) + "#");*/
								//bufferWrittertr.flush();
								System.out.println("artist id: " + get_artist_id(h5));
							    bufferWritterar.write(get_artist_id(h5)+ "#");
							    System.out.println("artist location: " + get_artist_location(h5));
							    bufferWritterar.write(get_artist_location(h5)+ "#");
							    //bufferWritter.flush();

							    System.out.println("artist name: " + get_artist_name(h5));
							    bufferWritterar.write(get_artist_name(h5));
							    bufferWritterar.newLine();
							    bufferWritterar.flush();
							    
								/*
								 * bufferWritter.write(""+get_song_id(h5) +
								 * "#"); bufferWritter.flush();
								 */
								//
								// bufferWritter.write("" + cou++ + "#");
								// bufferWritter.flush();

							    resS = get_artist_terms(h5);

							    //System.out.println("artist id: " + get_artist_id(h5));
							    String artistId = get_artist_id(h5);
							    
							    if(resS != null) {
							    	for(int v = 0 ; v<resS.length ; v++) {
							    	bufferWritterart.write(artistId + "#");
								    //bufferWritterart.flush();
								    bufferWritterart.write(resS[v]);
								    bufferWritterart.newLine();
								    bufferWritterart.flush();
							    	}
							    ...
							    if(resS != null) {
							    	for(int v = 0 ; v<resS.length ; v++) {
							    	bufferWrittersar.write(artistId + "#");
								    //bufferWrittersar.flush();
								    bufferWrittersar.write(resS[v]);
								    bufferWrittersar.newLine();
								    bufferWrittersar.flush();
							    	}
								    
							    }
							    
								/*bufferWrittertr.write(get_duration(h5) + "#");
								//bufferWrittertr.flush();
								System.out.println("duration: "
										+ get_duration(h5));

								bufferWrittertr.write(get_loudness(h5) + "#");
								//bufferWrittertr.flush();
								System.out.println("loudness: "
										+ get_loudness(h5));

								bufferWrittertr.write("" + get_energy(h5) + "#");
								//bufferWrittertr.flush();

								bufferWrittertr.write(get_title(h5)+ "#");
								
								String albumID = "AL" + System.currentTimeMillis() + random.nextInt(10) + random.nextInt(10) + random.nextInt(10);
								bufferWrittertr.write(albumID + "#");
								//bufferWrittertr.flush();
								bufferWrittertr.write(""+get_song_id(h5));
								bufferWrittertr.flush();
								bufferWrittertr.newLine();
								System.out.println("title: " + get_title(h5));
								
								Thread.sleep(1);
								
								bufferWritteral.write(albumID + "#");
								//bufferWritteral.flush();
								bufferWritteral.write(get_release(h5)+ "#");
								//bufferWritteral.flush();
								bufferWritteral.write("" + get_year(h5));
								bufferWritteral.newLine();
								bufferWritteral.flush();

								
								bufferWritterrec.write(albumID + "#");
								//bufferWritterrec.flush();
								//System.out.println("artist id: " + get_artist_id(h5));
								bufferWritterrec.write(get_artist_id(h5));
								bufferWritterrec.flush();
								bufferWritterrec.newLine();
								
								 //System.out.println("SongID : " + get_song_id(h5));
								    bufferWritterso.write( get_song_id(h5)+"#");
								    
								    bufferWritterso.write( get_year(h5)+ "#");
								    //bufferWritterso.flush();

								    //System.out.println("year: " + get_year(h5));

								    
								    bufferWritterso.write(get_title(h5));
								    bufferWritterso.flush();
								    bufferWritterso.newLine();
								    //System.out.println("title: " + get_title(h5));
								    
								    
								    bufferWritterco.write( get_song_id(h5)+"#");
									bufferWritterco.write(get_artist_id(h5));
									bufferWritterco.flush();
									bufferWritterco.newLine();*/
								
								/*
								 * System.out.println("track 7digitalid: " +
								 * get_track_7digitalid(h5));
								 * 
								 * resS = get_similar_artists(h5);
								 * 
								 * System.out.println("similar artists, length: "
								 * +resS .length+", elem 2: "+resS[20]);
								 * 
								 * resS = get_artist_terms(h5);
								 * 
								 * System.out.println("artists terms, length: "+resS
								 * . length+", elem 0: "+resS[0]);
								 * 
								 * res = get_artist_terms_freq(h5);
								 * 
								 * System.out.println("artists terms freq, length: "
								 * + res.length+", elem 0: "+res[0]);
								 * 
								 * res = get_artist_terms_weight(h5);
								 * 
								 * System.out.println(
								 * "artists terms weight, length: "
								 * +res.length+", elem 0: "+res[0]);
								 */
								// analysis

								/*
								 * System.out.println("end_of_fade_in: " +
								 * get_end_of_fade_in(h5));
								 * 
								 * System.out.println("key: " + get_key(h5));
								 * 
								 * System.out.println("key confidence: " +
								 ...
								 * 
								 * System.out.println("mode confidence: " +
								 ...
								 */
								/*
								 * System.out.println("segments start, length: "+
								 * res. length+", elem 20: "+res[20]);
								 * 
								 * res = get_segments_confidence(h5);
								 * 
								 * System.out.println(
								 * "segments confidence, length: "
								 * +res.length+", elem 20: "+res[20]);
								 * 
								 * res = get_segments_pitches(h5);
								 * 
								 * System.out.println("segments pitches, length: "
								 * +res .length+", elem 20: "+res[20]);
								 * 
								 * res = get_segments_timbre(h5);
								 * 
								 * System.out.println("segments timbre, length: "
								 * +res .length+", elem 20: "+res[20]);
								 * 
								 * res = get_segments_loudness_max(h5);
								 * 
								 * System.out.println(
								 * "segments loudness max, length: "
								 * +res.length+", elem 20: "+res[20]);
								 * 
								 * res = get_segments_loudness_max_time(h5);
								 * 
								 * System.out.println(
								 * "segments loudness max time, length: "
								 * +res.length+", elem 20: "+res[20]);
								 * 
								...
								/*
								 * System.out.println(
								 * "segments loudness start, length: "
								 * +res.length+", elem 20: "+res[20]);
								 * 
								 * res = get_sections_start(h5);
								 * 
								 * System.out.println("sections start, length: "+
								 * res. length+", elem 1: "+res[1]);
								 * 
								 * res = get_sections_confidence(h5);
								 * 
								 * System.out.println(
								 * "sections confidence, length: "
								 * +res.length+", elem 1: "+res[1]);
								 * 
								 * res = get_beats_start(h5);
								 * 
								 * System.out.println("beats start, length: "+res
								 * .length +", elem 1: "+res[1]);
								 * 
								 * res = get_beats_confidence(h5);
								 * 
								 * System.out.println("beats confidence, length: "
								 * +res .length+", elem 1: "+res[1]);
								 * 
								 * res = get_bars_start(h5);
								 * 
								 * System.out.println("bars start, length: "+res.
								 * length +", elem 1: "+res[1]);
								 * 
								 * res = get_bars_confidence(h5);
								 * 
								 * System.out.println("bars confidence, length: "
								 * +res .length+", elem 1: "+res[1]);
								 * 
								 * res = get_tatums_start(h5);
								 * 
								 * System.out.println("tatums start, length: "+res
								 * . length+", elem 3: "+res[3]);
								 * 
								 * res = get_tatums_confidence(h5);
								 * 
								 * System.out.println("tatums confidence, length: "
								 * +res .length+", elem 3: "+res[3]);
								 */
								// musicbrainz
								/*
								 * bufferWritter.write( get_year(h5)+ "#");
								 * bufferWritter.flush();
								 * 
								 * System.out.println("year: " + get_year(h5));
								 * 
								 ...
								 * if (resS.length > 0) {
								 * 
								 * System.out.println("artists mbtags, length: "+
								 * resS .length+", elem 0: "+resS[0]);
								 * 
								 * System.out.println(
								 * "artists mbtags count, length: "
	...
	private static String get_songtitle(H5File h5) {
